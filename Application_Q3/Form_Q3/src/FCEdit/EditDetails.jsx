...
export default function EditDetails() {
    ...
    const [user,setUser] = React.useState({...obj,email : sessionUser.email});
    ...
    <form onSubmit={editUser}>
     <div className='container'>
      ...
      />
        ...
        <label style={{textAlign:'left',marginRight: '15px',marginLeft:'25px' }} for="UploadFile">Upload_File: </label>
     ...
     <FormControl sx={{ m: 1.5, width: '35ch',flexDirection: 'row', alignItems: 'center' }} variant="outlined">
        <label for="cities" style={{marginLeft:"20px",marginRight:"10px"}}>Choose City: </label>
